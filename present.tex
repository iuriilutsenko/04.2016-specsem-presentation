...
\begin{frame}
Задачей данной работы является исследование изоморфных преобразований схемы правдоподобных рассуждений Шортлиффа, используемой в системе MYCIN, и составление их перечня, так называемой ``энциклопедии трансформации схемы Шортлиффа''.
\end{frame}
...
\item<2->{Задача подтверждения формул}
\item<3->{Задача конструирования формул}
\item<4->{Задача выявления отображений}
\item<5->{Задача доопределения функции комбинирования}
\end{enumerate}
\end{frame}
